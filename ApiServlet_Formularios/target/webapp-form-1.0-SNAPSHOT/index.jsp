        ...
        <div class="row mb-3">
            ...
            <div class="form-check col-sm-2">
                <input type="radio" name="idioma" value="es"
                       class="form-check-input" ${paramValues.roles.stream().anyMatch(v -> v.equals("es")).get() ? "checked" : ""}>
                <label class="form-checked-label">Español</label>
            </div>
            <div class="form-check col-sm-2">
                <input type="radio" name="idioma" value="en"
                       class="form-check-input" ${paramValues.roles.stream().anyMatch(v -> v.equals("en")).get() ? "checked" : ""}>
                <label class="form-checked-label">Inglés</label>
            </div>
            <div class="form-check col-sm-2">
                <input type="radio" name="idioma" value="fr"
                       class="form-check-input" ${paramValues.roles.stream().anyMatch(v -> v.equals("fr")).get() ? "checked" : ""}>
                <label class="form-checked-label">Francés</label>
            </div>
            <%
